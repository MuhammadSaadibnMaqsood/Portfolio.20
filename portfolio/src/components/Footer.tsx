...
const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-black text-white font-sans pt-12 md:pt-20 border-t border-white h-screen flex flex-col"
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          ...
          <p className="text-xs md:text-sm font-medium uppercase tracking-wide text-white/60">
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-2">
            <a
              ...
              className="text-xs md:text-sm font-medium uppercase tracking-wide hover:underline underline-offset-4"
            >
              Email ↗
            </a>
        ...
        >
          ...
          <div className="mt-8 md:mt-0">
            <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-white">
              © 2026
            </p>
          </div>
        </motion.div>
